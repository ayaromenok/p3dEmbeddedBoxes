...
module rpi3BBot(px=0, py=0, pz=0, rx=0, ry=0, rz=0, heightBot=22, isExtHolders = false, thickness=3){
    translate([px, py, pz])
    rotate([rx,ry,rz]){
    difference(){
...
module rpi3BTop(px=0, py=0, pz=0, rx=0, ry=0, rz=0, heightTop=22, isExtHolders = false, thickness=3){
    translate([px, py, pz])
    rotate([rx,ry,rz]){
        difference(){            
